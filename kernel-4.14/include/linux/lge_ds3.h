...
static inline int check_ds_connect_state(void) { return DS_STATE_DISCONNECTED; };
static inline void set_hallic_status(bool enable) { return; };
static inline void ds3_set_tcpc_ready(void)  { return; };
static inline void set_ds_vbus2_on(bool on)  { return; };
#endif
