...
enum {
	DUAL_ROLE_PROP_TYPEC_TYPEC_ATTACHED_NONE,
	DUAL_ROLE_PROP_TYPEC_TYPEC_ATTACHED_CC1,
	DUAL_ROLE_PROP_TYPEC_TYPEC_ATTACHED_CC2,
	DUAL_ROLE_PROP_TYPEC_TYPEC_ATTACHED_MAX,
};
#endif
