...
// ALPS05103013
	...
	dev_info(priv->dev, "%s(), hp_impedance = %d, hp_hifi_mode = %d, efuse = %d\n",
		 __func__, priv->hp_impedance, priv->hp_hifi_mode, priv->hp_current_calibrate_val);
