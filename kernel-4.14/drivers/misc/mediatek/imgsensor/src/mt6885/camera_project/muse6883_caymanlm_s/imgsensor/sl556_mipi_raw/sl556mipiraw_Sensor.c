...
#endif
kal_uint16 addr_data_pair_custom1_24fps_sl556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7067,
    0x004a, 0x0100,
    ...
    0x0030, 0x1111,
    0x0032, 0x1111,
    0x0006, 0x0a2c, //frame length
    0x0116, 0x07b6,
    0x0a22, 0x0000,
    0x0a12, 0x0a20, //formatter column output size
    0x0a14, 0x0798, //formatter row output size
    0x003e, 0x0000,
    0x0074, 0x0a2a, //the integration time control
    0x0070, 0x0515,
    0x0804, 0x0200,
    0x0a04, 0x014a,
    0x090c, 0x0fdc,
    0x090e, 0x002d,
    0x0040, 0x0001, //Fsync slave
    0x0042, 0x0101, //Fsync slave
    0x003e, 0x0000, //Fsync slave
    0x0126, 0x00f9,
    0x0902, 0x4319,
    0x0914, 0xc10a,
    0x0916, 0x071f,
...
static void custom1_setting(void)
{
	...
	sl556_table_write_cmos_sensor(
		addr_data_pair_custom1_24fps_sl556,
		sizeof(addr_data_pair_custom1_24fps_sl556) /
		sizeof(kal_uint16));
}
			...
			do {
				*sensor_id = return_sensor_id();
				if (*sensor_id == (imgsensor_info.sensor_id)) {				
					...
					strcpy(aux_sensor_name, "sl556_lgit");/*LGE_CHANGE, 2020-04-06, add the camera identifying logic , bk.bae@lge.com*/
					return ERROR_NONE;
				}	
...
static kal_uint32 open(void)
{
	...
	LOG_DEBUG("[open]: PLATFORM:MT6883,MIPI 2LANE\n");
...
{
    printk("SL556_MIPI_RAW Depth SensorInit\n");
