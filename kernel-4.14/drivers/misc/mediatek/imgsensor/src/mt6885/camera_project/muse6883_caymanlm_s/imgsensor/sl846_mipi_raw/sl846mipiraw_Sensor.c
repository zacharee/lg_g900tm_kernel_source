...
#include "sl846mipiraw_Sensor.h"

#define PFX "sl846_camera_sensor"
...
#define per_frame 1
extern char wide_sensor_name[20];/*LGE_CHANGE, 2020-04-06, add the camera identifying logic , bk.bae@lge.com*/

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SL846_SENSOR_ID,
	...
	.mipi_settle_delay_mode = 1,//MIPI_SETTLEDELAY_MANUAL, //0,MIPI_SETTLEDELAY_AUTO; 1,MIPI_SETTLEDELAY_MANNUAL
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = 
{
 ...
 { 3264, 2448,   0, 504,   3264, 1440,   1632,  720, 176, 0, 1280,  720,   0, 0, 1280, 720 },
};// slim video
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_sl846[] = {
	0x2000, 0x987A, 
	0x2002, 0x00FF,
	0x2004, 0x0047, 
	0x2006, 0x3FFF,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(
		addr_data_pair_init_sl846,
		sizeof(addr_data_pair_init_sl846) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_sl846[] = {
	0x002E, 0x3311,
	0x0032, 0x3311,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
#if MULTI_WRITE
	table_write_cmos_sensor(
		addr_data_pair_preview_sl846,
		sizeof(addr_data_pair_preview_sl846) /
		sizeof(kal_uint16));
#else
	LOG_INF("E preview\n");
	//Sensor Information////////////////////////////
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_sl846[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
kal_uint16 addr_data_pair_capture_30fps_sl846[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	table_write_cmos_sensor(
		addr_data_pair_capture_30fps_sl846,
		sizeof(addr_data_pair_capture_30fps_sl846) /
		sizeof(kal_uint16));
	} else {
	table_write_cmos_sensor(
		addr_data_pair_capture_fps_sl846,
		sizeof(addr_data_pair_capture_fps_sl846) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_sl846[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
#if MULTI_WRITE
	table_write_cmos_sensor(
		addr_data_pair_video_sl846,
		sizeof(addr_data_pair_video_sl846) /
		sizeof(kal_uint16));
#else
	  //Sensor Information////////////////////////////
	  //Sensor		: Hi-846
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_sl846[] = {
	0x002E, 0x7711,
	0x0032, 0x7711,
	0x0026, 0x0148,
	0x002C, 0x08C7,
...
#if MULTI_WRITE
	table_write_cmos_sensor(
		addr_data_pair_hs_video_sl846,
		sizeof(addr_data_pair_hs_video_sl846) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_sl846[] = {
	0x002E, 0x3311,
	0x0032, 0x3311,
	0x0026, 0x0238,
	0x002C, 0x07D7,
...
#if MULTI_WRITE
	table_write_cmos_sensor(
		addr_data_pair_slim_video_sl846,
		sizeof(addr_data_pair_slim_video_sl846) /
		sizeof(kal_uint16));
#else
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			strcpy(wide_sensor_name, "sl846_cowell");/*LGE_CHANGE, 2020-04-06, add the camera identifying logic , bk.bae@lge.com*/
			return ERROR_NONE;
			}
...
{
    printk("[SL846] Start Preview Mode\n");
	spin_lock(&imgsensor_drv_lock);
...
{
	spin_lock(&imgsensor_drv_lock);
	printk("[SL846] Start Capture Mode\n");
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	printk("[SL846] Start NormalVideo Mode\n");
	spin_lock(&imgsensor_drv_lock);
...
{
	printk("SL846_MIPI_RAW_SensorInit\n");
