...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 4704, 3512,   0,   0, 4704, 3512,  2352, 1756, 12,  2, 2328, 1752, 0, 0, 2328, 1752},     // preview (2328 x 1752)//DIFF
	{ 4704, 3512,   0,   2, 4704, 3508,  4704, 3508, 24,  2, 4656, 3504, 0, 0, 4656, 3504},     // capture (4656 x 3504)
	{ 4704, 3512,   0,   2, 4704, 3508,  4704, 3508, 24,  2, 4656, 3504, 0, 0, 4656, 3504},     // video (4656 x 3504)
	{ 4704, 3512, 336, 670, 4032, 2172,  1344,  724, 32,  2, 1280, 	720, 0, 0, 1280,  720},   // hs video (1280 x 720)//DIFF
	{ 4704, 3512, 336, 672, 4032, 2168,  2016, 1084, 48,  2, 1920, 1080, 0, 0, 1920, 1080},     // slim video (1920 x 1080)//DIFF
...
kal_uint16 addr_data_pair_preview_hi1634[] = {
	...
	0x0224, 0x002C,	// 5: tg/y_addr_start2
	0x022A, 0x0015,	// 6: tg/y_addr_end0
	0x022C, 0x0E25,	// 7: tg/y_addr_end1
	0x022E, 0x0DE1,	// 8: tg/y_addr_end2
	0x0234, 0x3311,	// 9: tg/y_inc_0
	0x0236, 0x3311,	// 10: tg/y_inc_1
	0x0238, 0x3311,	// 11: tg/y_inc_2
	0x023A, 0x2222,	// 12: tg/y_addr_dummy
	...
	0x0F00, 0x0400,	// 21: fmt/fmt_vs_ctrl
	0x0F04, 0x0004,	// 22: fmt/x_start
	0x0B04, 0x00FC,	// 23: isp_common/isp_en
	0x0B12, 0x0918,	// 24: isp_common/x_output_size
	0x0B14, 0x06D8,	// 25: isp_common/y_output_size
	0x0B20, 0x0200,	// 26: isp_common/hbin_ctrl1
	0x1100, 0x1100,	// 27: lsc/lsc_ctl_a
	0x1108, 0x0402,	// 28: lsc/spare
	0x1116, 0x0000,	// 29: lsc/win_x
	0x1118, 0x0000,	// 30: lsc/win_y
	0x0A0A, 0x8388,	// 31: sreg/sreg5
	0x0A10, 0xB440,	// 32: sreg/sreg8
	0x0C14, 0x0008,	// 33: tpg/tpg_x_offset
	0x0C18, 0x1240,	// 34: tpg/tpg_x_size
	0x0C1A, 0x0700,	// 35: tpg/tpg_y_size
	...
	0x074C, 0x0100,	// 42: smu/pll_cfg_mipi_g
	...
	0x1010, 0x06CD,	// 48: mipi/mipi_ch0_vblank_delay
	0x1012, 0x0091,	// 49: mipi/mipi_ch0_hblank_delay0
	...
	0x1020, 0xC107,	// 53: mipi/mipi_tx_time2
	0x1022, 0x071D,	// 54: mipi/mipi_tx_time3
	0x1024, 0x0307,	// 55: mipi/mipi_tx_time4
	0x1026, 0x0C0B,	// 56: mipi/mipi_tx_time5
	0x1028, 0x1209,	// 57: mipi/mipi_tx_time6
	0x102A, 0x0C0A,	// 58: mipi/mipi_tx_time7
	0x102C, 0x1400,	// 59: mipi/mipi_tx_time8
	0x1038, 0x0000,	// 60: mipi/mipi_channel_ctrl
	0x103E, 0x0101,	// 61: mipi/mipi_col_read_ctrl
	...
	0x1066, 0x06F1,	// 66: mipi/mipi_cont_vblank_delay
	0x1600, 0x0400,	// 67: pdaf/pdaf_ctrl0
...
kal_uint16 addr_data_pair_capture_30fps_hi1634[] = {
	...
	0x1010, 0x0DC3,	// 48: mipi/mipi_ch0_vblank_delay
	...
	0x1046, 0x01B0,	// 64: mipi/mipi_pd_row_size
	0x1048, 0x0090,	// 65: mipi/mipi_pd_max_col_size
	0x1066, 0x0E09,	// 66: mipi/mipi_cont_vblank_delay
...
kal_uint16 addr_data_pair_video_hi1634[] = {
	...
	0x0204, 0x0000, // 1: tg/binning_mode
	0x0206, 0x02C6, // 2: tg/line_length_pck
	0x020A, 0x0E1D, // 3: tg/coarse_integ_time
	0x020E, 0x0E21, // 4: tg/frame_length_lines
	0x0224, 0x002E, // 5: tg/y_addr_start2
	0x022A, 0x0017, // 6: tg/y_addr_end0
	0x022C, 0x0E1B, // 7: tg/y_addr_end1
	0x022E, 0x0DE1, // 8: tg/y_addr_end2
	...
	0x0F00, 0x0000, // 21: fmt/fmt_vs_ctrl
	0x0F04, 0x0008, // 22: fmt/x_start
	0x0B04, 0x00DE, // 23: isp_common/isp_en
	0x0B12, 0x1230, // 24: isp_common/x_output_size
	0x0B14, 0x0DB0, // 25: isp_common/y_output_size
	0x0B20, 0x0100, // 26: isp_common/hbin_ctrl1
	0x1100, 0x1100, // 27: lsc/lsc_ctl_a
	...
	0x1116, 0x0000, // 29: lsc/win_x
	0x1118, 0x0000, // 30: lsc/win_y
	0x0C14, 0x0008, // 31: tpg/tpg_x_offset
	0x0C18, 0x1240, // 32: tpg/tpg_x_size
	0x0C1A, 0x0E00, // 33: tpg/tpg_y_size
	0x0736, 0x0050, // 34: smu/pll_cfg_ramp_tg_d
	0x0738, 0x0002, // 35: smu/pll_cfg_ramp_tg_e
	0x073C, 0x0700, // 36: smu/pll_cfg_ramp_tg_g
	0x0746, 0x00D4, // 37: smu/pll_cfg_mipi_d
	0x0748, 0x0002, // 38: smu/pll_cfg_mipi_e
	0x074A, 0x0900, // 39: smu/pll_cfg_mipi_f
	0x074C, 0x0000, // 40: smu/pll_cfg_mipi_g
	0x074E, 0x0100, // 41: smu/pll_cfg_mipi_h
	0x1200, 0x0B46, // 42: bdpc/bdpc_control_1
	0x1202, 0x1E00, // 43: bdpc/bdpc_control_2
	0x1000, 0x0300, // 44: mipi/mipi_tx_ctrl
	0x1002, 0xC611, // 45: mipi/mipi_tx_op_mode
	0x1004, 0x2BB0, // 46: mipi/mipi_data_ctrl
	0x1010, 0x0DC7, // 47: mipi/mipi_ch0_vblank_delay
	0x1012, 0x0141, // 48: mipi/mipi_ch0_hblank_delay0
	0x1014, 0x0020, // 49: mipi/mipi_ch0_hblank_delay1
	0x1016, 0x0020, // 50: mipi/mipi_ch0_hblank_delay2
	0x101A, 0x0020, // 51: mipi/mipi_ch1_hblank_delay
	0x1020, 0xC10D, // 52: mipi/mipi_tx_time2
	0x1022, 0x0B39, // 53: mipi/mipi_tx_time3
	0x1024, 0x030C, // 54: mipi/mipi_tx_time4
	0x1026, 0x1812, // 55: mipi/mipi_tx_time5
	0x1028, 0x1610, // 56: mipi/mipi_tx_time6
	0x102A, 0x170A, // 57: mipi/mipi_tx_time7
	0x102C, 0x2500, // 58: mipi/mipi_tx_time8
	0x1038, 0x0000, // 59: mipi/mipi_channel_ctrl
	0x103E, 0x0001, // 60: mipi/mipi_col_read_ctrl
	0x1042, 0x0008, // 61: mipi/mipi_pd_sep_ctrl
	0x1044, 0x0120, // 62: mipi/mipi_pd_col_size
	0x1046, 0x01B0, // 63: mipi/mipi_pd_row_size
	0x1048, 0x0090, // 64: mipi/mipi_pd_max_col_size
	0x1066, 0x0E0B, // 65: mipi/mipi_cont_vblank_delay
	0x1600, 0x0000, // 66: pdaf/pdaf_ctrl0
	0x1608, 0x0020, // 67: pdaf/pdaf2_roi_x_st
	0x160A, 0x1200, // 68: pdaf/pdaf2_roi_x_wid
	0x160C, 0x001A, // 69: pdaf/pdaf2_roi_y_st
	0x160E, 0x0D80, // 70: pdaf/pdaf2_roi_y_hgt
};
#endif
...
kal_uint16 addr_data_pair_hs_video_hi1634[] = {
	...
	0x0B00, 0x0000,	// 0: isp_common/mode_select
	0x0204, 0x0001,	// 1: tg/binning_mode
	0x0206, 0x02D5,	// 2: tg/line_length_pck
	0x020A, 0x0479,	// 3: tg/coarse_integ_time
	0x020E, 0x047D,	// 4: tg/frame_length_lines
	0x0224, 0x02CA,	// 5: tg/y_addr_start2
	0x022A, 0x0017,	// 6: tg/y_addr_end0
	0x022C, 0x0E31,	// 7: tg/y_addr_end1
	0x022E, 0x0B43,	// 8: tg/y_addr_end2
	0x0234, 0x1111,	// 9: tg/y_inc_0
	0x0236, 0x3333,	// 10: tg/y_inc_1
	0x0238, 0x3333,	// 11: tg/y_inc_2
	0x023A, 0x1133,	// 12: tg/y_addr_dummy
	0x0268, 0x0141,	// 13: tg/analog_power_off_min_vblank
	0x0404, 0x0190,	// 14: adco/col_start
	0x0406, 0x10BC,	// 15: adco/col_end
	0x0440, 0x0070,	// 16: adco/adco_start_pcnt
	0x0D28, 0x0190,	// 17: adpc/adpc_col_start
	0x0D2A, 0x10BF,	// 18: adpc/adpc_col_end
	0x0524, 0x6060,	// 19: d2a_wrapper/ramp_pofs_1
	0x0526, 0x6060,	// 20: d2a_wrapper/ramp_pofs_2
	0x0F00, 0x0800,	// 21: fmt/fmt_vs_ctrl
	0x0F04, 0x0008,	// 22: fmt/x_start
	0x0B04, 0x00FC,	// 23: isp_common/isp_en
	0x0B12, 0x0500,	// 24: isp_common/x_output_size
	0x0B14, 0x02D0,	// 25: isp_common/y_output_size
	0x0B20, 0x0300,	// 26: isp_common/hbin_ctrl1
	0x1100, 0x1100,	// 27: lsc/lsc_ctl_a
	0x1108, 0x0000,	// 28: lsc/spare
	0x1116, 0x0218,	// 29: lsc/win_x
	0x1118, 0x0452,	// 30: lsc/win_y
	0x0A0A, 0x838A,	// 31: sreg/sreg5
	0x0A10, 0xAC70,	// 32: sreg/sreg8
	0x0C14, 0x0018,	// 33: tpg/tpg_x_offset
	0x0C18, 0x0F00,	// 34: tpg/tpg_x_size
	0x0C1A, 0x0300,	// 35: tpg/tpg_y_size
	0x0736, 0x0064,	// 36: smu/pll_cfg_ramp_tg_d
	0x0738, 0x0002,	// 37: smu/pll_cfg_ramp_tg_e
	0x073C, 0x0700,	// 38: smu/pll_cfg_ramp_tg_g
	0x0746, 0x00D4,	// 39: smu/pll_cfg_mipi_d
	0x0748, 0x0002,	// 40: smu/pll_cfg_mipi_e
	0x074A, 0x0900,	// 41: smu/pll_cfg_mipi_f
	0x074C, 0x0200,	// 42: smu/pll_cfg_mipi_g
	0x074E, 0x0100,	// 43: smu/pll_cfg_mipi_h
	0x1200, 0x0946,	// 44: bdpc/bdpc_control_1
	0x1000, 0x0300,	// 45: mipi/mipi_tx_ctrl
	0x1002, 0xC611,	// 46: mipi/mipi_tx_op_mode
	0x1004, 0x2BB0,	// 47: mipi/mipi_data_ctrl
	0x1010, 0x0399,	// 48: mipi/mipi_ch0_vblank_delay
	0x1012, 0x003A,	// 49: mipi/mipi_ch0_hblank_delay0
	0x1014, 0x0020,	// 50: mipi/mipi_ch0_hblank_delay1
	0x1016, 0x0020,	// 51: mipi/mipi_ch0_hblank_delay2
	0x101A, 0x0020,	// 52: mipi/mipi_ch1_hblank_delay
	0x1020, 0xC105,	// 53: mipi/mipi_tx_time2
	0x1022, 0x0514,	// 54: mipi/mipi_tx_time3
	0x1024, 0x0305,	// 55: mipi/mipi_tx_time4
	0x1026, 0x0908,	// 56: mipi/mipi_tx_time5
	0x1028, 0x0E07,	// 57: mipi/mipi_tx_time6
	0x102A, 0x0905,	// 58: mipi/mipi_tx_time7
	0x102C, 0x0F00,	// 59: mipi/mipi_tx_time8
	0x1038, 0x0000,	// 60: mipi/mipi_channel_ctrl
	0x103E, 0x0201,	// 61: mipi/mipi_col_read_ctrl
	0x1042, 0x0008,	// 62: mipi/mipi_pd_sep_ctrl
	0x1044, 0x0120,	// 63: mipi/mipi_pd_col_size
	0x1046, 0x01B0,	// 64: mipi/mipi_pd_row_size
	0x1048, 0x0090,	// 65: mipi/mipi_pd_max_col_size
	0x1066, 0x03B2,	// 66: mipi/mipi_cont_vblank_delay
	0x1600, 0x0000,	// 67: pdaf/pdaf_ctrl0
	0x1608, 0x0020,	// 68: pdaf/pdaf2_roi_x_st
	0x160A, 0x1200,	// 69: pdaf/pdaf2_roi_x_wid
	0x160C, 0x001A,	// 70: pdaf/pdaf2_roi_y_st
...
kal_uint16 addr_data_pair_slim_video_hi1634[] = {
	...
	//Frame Length	  : 2298
	//Line Length 	  : 725
	//Max Fps 	      : 60.02fps (V-blank 8.83ms)
	//Pixel order 	  : Green 1st(=GR)
	//X/Y-flip        : no-flip
	////////////////////////////////////////////////

	0x0B00, 0x0000,	// 0: isp_common/mode_select
	0x0204, 0x0201,	// 1: tg/binning_mode
	0x0206, 0x02D5,	// 2: tg/line_length_pck
	0x020A, 0x08F6,	// 3: tg/coarse_integ_time
	0x020E, 0x08FA,	// 4: tg/frame_length_lines
	0x0224, 0x02CC,	// 5: tg/y_addr_start2
	0x022A, 0x0015,	// 6: tg/y_addr_end0
	0x022C, 0x0E25,	// 7: tg/y_addr_end1
	0x022E, 0x0B41,	// 8: tg/y_addr_end2
	0x0234, 0x3311,	// 9: tg/y_inc_0
	0x0236, 0x3311,	// 10: tg/y_inc_1
	0x0238, 0x3311,	// 11: tg/y_inc_2
	0x023A, 0x2222,	// 12: tg/y_addr_dummy
	0x0268, 0x0141,	// 13: tg/analog_power_off_min_vblank
	0x0404, 0x0198,	// 14: adco/col_start
	0x0406, 0x10B4,	// 15: adco/col_end
	0x0440, 0x00E6,	// 16: adco/adco_start_pcnt
	0x0D28, 0x0198,	// 17: adpc/adpc_col_start
	0x0D2A, 0x10B7,	// 18: adpc/adpc_col_end
	0x0524, 0x6060,	// 19: d2a_wrapper/ramp_pofs_1
	0x0526, 0x6060,	// 20: d2a_wrapper/ramp_pofs_2
	0x0F00, 0x0400,	// 21: fmt/fmt_vs_ctrl
	0x0F04, 0x0008,	// 22: fmt/x_start
	0x0B04, 0x00FC,	// 23: isp_common/isp_en
	0x0B12, 0x0780,	// 24: isp_common/x_output_size
	0x0B14, 0x0438,	// 25: isp_common/y_output_size
	0x0B20, 0x0200,	// 26: isp_common/hbin_ctrl1
	0x1100, 0x1100,	// 27: lsc/lsc_ctl_a
	0x1108, 0x0000,	// 28: lsc/spare
	0x1116, 0x021A,	// 29: lsc/win_x
	0x1118, 0x0454,	// 30: lsc/win_y
	0x0A0A, 0x838A,	// 31: sreg/sreg5
	0x0A10, 0xB070,	// 32: sreg/sreg8
	0x0C14, 0x0010,	// 33: tpg/tpg_x_offset
	0x0C18, 0x0F00,	// 34: tpg/tpg_x_size
	0x0C1A, 0x0480,	// 35: tpg/tpg_y_size
	0x0736, 0x0064,	// 36: smu/pll_cfg_ramp_tg_d
	0x0738, 0x0002,	// 37: smu/pll_cfg_ramp_tg_e
	0x073C, 0x0700,	// 38: smu/pll_cfg_ramp_tg_g
	0x0746, 0x00D4,	// 39: smu/pll_cfg_mipi_d
	...
	0x1002, 0xC611,	// 46: mipi/mipi_tx_op_mode
	0x1004, 0x2BB0,	// 47: mipi/mipi_data_ctrl
	0x1010, 0x0575,	// 48: mipi/mipi_ch0_vblank_delay
	0x1012, 0x0065,	// 49: mipi/mipi_ch0_hblank_delay0
	0x1014, 0x0020,	// 50: mipi/mipi_ch0_hblank_delay1
	0x1016, 0x0020,	// 51: mipi/mipi_ch0_hblank_delay2
	0x101A, 0x0020,	// 52: mipi/mipi_ch1_hblank_delay
	0x1020, 0xC107,	// 53: mipi/mipi_tx_time2
	...
	0x1046, 0x01B0,	// 64: mipi/mipi_pd_row_size
	0x1048, 0x0090,	// 65: mipi/mipi_pd_max_col_size
	0x1066, 0x0599,	// 66: mipi/mipi_cont_vblank_delay
	0x1600, 0x0400,	// 67: pdaf/pdaf_ctrl0
	0x1608, 0x0020,	// 68: pdaf/pdaf2_roi_x_st
	0x160A, 0x1200,	// 69: pdaf/pdaf2_roi_x_wid
	0x160C, 0x001A,	// 70: pdaf/pdaf2_roi_y_st
...
static kal_uint32 open(void)
{
	...
	LOG_INF("SK hynix Hi-1634 Sensor Init Start\n");
	sensor_init();
	LOG_INF("SK hynix Hi-1634 Sensor Init Stop\n");
	spin_lock(&imgsensor_drv_lock);
