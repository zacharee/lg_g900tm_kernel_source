...
{
	//struct iommu_fwspec *fwspec;//error: unused variable 'fwspec' [-Werror,-Wunused-variable]
	//unsigned int larbid, portid, domain_id = 0;//error: unused variable 'larbid' [-Werror,-Wunused-variable]
