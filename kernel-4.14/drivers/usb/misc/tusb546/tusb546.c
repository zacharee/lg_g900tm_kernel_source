...
{
	if (!tusb) { //TD#777_Dereference before null check
...
{
	if (!tusb) { //TD#883_Dereference before null check
		pr_err("%s is not ready!\n",__func__);
		return;
	}
