...
/* 2020-12-14 jongwan84.kim@lge.com LGP_DATA_TCPIP_IPV6_MTU [START] */
#include <cutils/properties.h>
/* 2020-12-14 jongwan84.kim@lge.com LGP_DATA_TCPIP_IPV6_MTU [END] */
...
void configure_interface(const char *uplink_interface, const char *plat_prefix, const char *v4_addr,
  ...
  /* 2020-12-14 jongwan84.kim@lge.com LGP_DATA_TCPIP_IPV6_MTU [START] */
  // SKT MTU Requirement : Under 1440
  patch_code_id("LPCP-963@n@c@clatd@clatd.c@1");
  char propVal [PROPERTY_VALUE_MAX];
  memset(propVal, 0x0, PROPERTY_VALUE_MAX);
  int ret = property_get("gsm.sim.operator.numeric", propVal, "");
  if (ret > 0 && ((strncasecmp(propVal, "45005", 5) == 0 ) || (strncasecmp(propVal, "45011", 5) == 0 ))) {
    if (mtu > 1440) {
      mtu = 1440;
      logmsg(ANDROID_LOG_INFO, "SKT Set MTU 1440 in CLAT");
    }
  }
  /* 2020-12-14 jongwan84.kim@lge.com LGP_DATA_TCPIP_IPV6_MTU [END] */
