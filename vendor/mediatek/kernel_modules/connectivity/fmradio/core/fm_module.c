...
#ifdef CONFIG_LGE_TOUCH_CORE_BASE
...
#if defined(CONFIG_LGE_FM_LNA_SW)
			FmDrv_GPIO_FM_TDMB_Select(FM_SEL);
#endif

#if defined(CONFIG_LGE_TOUCH_CORE_BASE)
...
#if !(defined(CONFIG_OF) && defined(CONFIG_LGE_FM_LNA_SW))
