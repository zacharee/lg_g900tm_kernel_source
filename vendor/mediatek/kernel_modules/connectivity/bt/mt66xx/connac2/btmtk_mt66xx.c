...
//BT_S : [CONBT-7716][ALPS05159698] BT: add dump for conninfra wakeup fail in bt off
	if (ret) {
		bgfsys_power_on_dump_cr();
		return ret;
	}
//BT_E : [CONBT-7716][ALPS05159698] BT: add dump for conninfra wakeup fail in bt off
...
//BT_S : [CONBT-7776][ALPS05203224] WIFI power consumption issue
	CLR_BIT(CONN_INFRA_CFG_EMI_CTL_BT_EMI_REQ_BT, BT_EMI_CTRL_BIT1);
//BT_E : [CONBT-7776][ALPS05203224] WIFI power consumption issue
