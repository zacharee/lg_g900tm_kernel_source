...
struct ike_sa_t {
	...
	status_t(*set_psid)(ike_sa_t *this, int p_sessionid);
	int(*get_psid)(ike_sa_t *this);
	...
	status_t (*set_device_identity_type) (ike_sa_t *this, chunk_t identity_type);
	int(*get_device_identity_type)(ike_sa_t *this);
