...
#if OPENSSL_VERSION_NUMBER < 0x10100000L //0x10100080L   LGP_DATA_USE_BORINGSSL
OPENSSL_KEY_FALLBACK(RSA, key, n, e, d)
OPENSSL_KEY_FALLBACK(RSA, factors, p, q)
OPENSSL_KEY_FALLBACK(RSA, crt_params, dmp1, dmq1, iqmp)
//LGP_DATA_USE_BORINGSSL #define BN_secure_new() BN_new()
#endif
#if OPENSSL_VERSION_NUMBER < 0x10100080L //LGP_DATA_USE_BORINGSSL
